## This file contains the implementation of the Structured Neural Network (StrNN) model
## The StrNN model is a neural network with a configurable binary mask on the weights
## The mask is used to enforce a structured connectivity pattern in the network
## It is copy-pasted from the original implementation in the paper
# https://arxiv.org/abs/2311.02221
# , available at:
## https://github.com/rgklab/StructuredNNs
## We did not import the package because it required python 3.11 and we are using python 3.10
